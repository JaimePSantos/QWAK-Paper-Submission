...
\begin{figure}[!h]
  \begin{minipage}{.5\linewidth}
    \centering
    \subfloat[Graph building tool]{\label{fig:gui-graph}\includegraphics[scale=.25]{gui-graph.png}}
  \end{minipage}
  \begin{minipage}{.5\linewidth}
    \centering
    \subfloat[Probability distribution plot]{\label{fig:gui-probDist}\includegraphics[scale=.25]{gui-probDist.png}}
  \end{minipage}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=.25]{gui-stDev.png}
