...
\begin{figure}[!h]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\linewidth]{img/QWAK/Benchmark/staticBenchmark_F25_T1000_ST25_TM50_SAMP100.png}
        \caption{Varying the number of vertices.}
        \label{fig:expmVsDiag}
    \end{subfigure}
    \hfill 
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\linewidth]{img/QWAK/Benchmark/dynamicBenchmark_WSTART1_WEND30_WST1_SAMP200.png}
...
%class QWAK(graph, initStateList=None, customStateList=None, 
%           laplacian=False,markedSearch=None)
%\end{lstlisting}
