...
\section{Theoretical Background}\label{sec:theor_background}
    \subfile{Sections/TheoreticalBackground/TheorBackgroundIntro}
    \subsection{Continuous-Time Quantum Walk}
        \subfile{Sections/TheoreticalBackground/contTimeQW}
    \subsection{Transport Properties}
        \subfile{Sections/TheoreticalBackground/TransportProp/transportProp-intro}
        \subfile{Sections/TheoreticalBackground/TransportProp/transportProp}
    \subsection{Searching Algorithm}
        \subfile{Sections/TheoreticalBackground/SearchingAlgorithm}\label{sec:theor_searching}
    \subsection{Stochastic Quantum Walk}
        \subfile{Sections/TheoreticalBackground/stochasticCtqw}
